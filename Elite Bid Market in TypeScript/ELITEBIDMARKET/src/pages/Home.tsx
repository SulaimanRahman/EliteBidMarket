...
import {hero_section, trending_auctions, contact_us_section} from '../constants/home_page_data.ts'
import {Listing, ListingSold, Testimonial, InputText, MessageInput, Button, Footer} from '../components'
...
const Home = () => {
  ...
  const showTrendingAuction = () => {
    ...
    return <React.Fragment><div>{divs}</div></React.Fragment>
  };
  ...
  return (
    <div className='flex flex-col' >
      ...
      <div className='flex md:hidden flex-col items-center justify-center bg-primary'>
        ...
        <div className='flex flex-col px-vertical items-center justify-center'>
          ...
          <div className='flex items-center justify-center'>
            <img src={`${hero_section.hero_image}`} className='w-image px-vertical' />
          </div>
      ...
      <div className='flex flex-col bg-secondary pb-20 text-white'>
        ...
        <div className='flex overflow-x-scroll md:gap-10 gap-5'>
          <div className='min-w-listingxs md:min-w-listingmd lg:min-w-listinglg max-w-listingxs md:max-w-listingmd lg:max-w-listinglg'>
            <Listing image={lamborghini} auctioneerName='Thomas Jerry' verified={false} title="2016 Lamborghini Huracán" currentBid='$1.9 million' endTime='01:29:35'/>
          </div>
          <div className='min-w-listingxs md:min-w-listingmd lg:min-w-listinglg max-w-listingxs md:max-w-listingmd lg:max-w-listinglg'>
            <Listing image={lamborghini} auctioneerName='Thomas Jerry' verified={false} title="2016 Lamborghini Huracán" currentBid='$1.9 million' endTime='01:29:35'/>
          </div>
      ...
      <div className='flex flex-col bg-primary pb-20 text-white'>
        ...
        <div className='flex overflow-x-scroll md:gap-10 gap-5'>
          <div className='min-w-listingxs md:min-w-listingmd lg:min-w-listinglg max-w-listingxs md:max-w-listingmd lg:max-w-listinglg'>
            <ListingSold image={lamborghini} auctioneerName='Thomas Jerry' verified={false} title="2016 Lamborghini Huracán" currentBid='$1.9 million' endTime='01:29:35'/>
          </div>
          <div className='min-w-listingxs md:min-w-listingmd lg:min-w-listinglg max-w-listingxs md:max-w-listingmd lg:max-w-listinglg'>
            <ListingSold image={lamborghini} auctioneerName='Thomas Jerry' verified={false} title="2016 Lamborghini Huracán" currentBid='$1.9 million' endTime='01:29:35'/>
          </div>
      ...
      <div className='flex flex-col bg-secondary pb-20 text-white'>
        ...
        <div className='flex justify-center mx-10'>
          <Testimonial comment="I'm addicted to the excitement of winning auctions on this platform! The variety of items is incredible, and the bidding process is straightforward. I've scored some amazing deals here." name="Jane D. - Happy Bidder"/>
        </div>
        <div className='flex flex-col md:flex-row'>
          <div className='flex justify-center mx-10'>
            <Testimonial comment="I've been using this site for a while now, and it's become my go-to for unique finds. The support team is responsive, and I've never had any issues. Highly recommended!" name="Mike S. - Frequent User"/>
          </div>
          <div className='flex justify-center mx-10'>
            <Testimonial comment="As a seller, I've had a fantastic experience on this platform. It's easy to list items, and I've had great success with sales. Plus, the community is supportive and friendly." name="Emily R. - Successful Seller"/>
          </div>
        </div>
      </div>
      ...
      <div className='flex justify-around bg-primary md:pb-20 pb-10'>
        <div className='flex flex-col text-contactus font-bold md:my-10 my-5 md:mx-10 mx-5'>
          ...
          <div className='w-contactus'>
            Get in <span className='text-white'>touch with us</span> for more information
          </div>
        ...
        <div className='md:flex flex-col hidden items-center justify-between md:my-10 md:mx-10 '>
          ...
          <div className='flex w-2/4 items-center justify-center'>
            <img src={`${contact_us_section.contact_us_icon}`} className='w-image' />
          </div>
          <div className='text-contactus font-bold w-contactus'>
            Just <span className='text-white'>one step away</span> from connecting
          </div>
