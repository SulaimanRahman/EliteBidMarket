    ...
    <div className="bg-primary flex justify-around p-10 text-subtext">
      ...
      <div className="my-30 font-bold flex w-full h-full text-center flex-col text-subtitle">
        <div className="w-[650px] font-bold text-center rtl:text-left">
          <span className="text-black">Welcome Back! Instant Access to</span><br></br>
          <span className="text-white">Exciting Auctions</span>
        </div>
        <center><img src={sign_in_image} className="App-logo w-image object-center" alt="logo" /></center>
      </div>
      ...
      <div className="my-30 bg-white font-bold flex p-10 rounded-lg flex-col w-full h-full flex-col text-center">
        ...
        <div className="font-normal text-lg">
          ...
          <Link to="/SignUp" className="text-yellow-300"> Register</Link>
        </div>
      </div>
    </div>
  )
