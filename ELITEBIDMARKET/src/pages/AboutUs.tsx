  ...
  return (
    <div>
      ...
      <div className='md:px-40 p-10'>
        ...
        We are passionate about auctions and have created a platform dedicated
        ...
        Founded in 2023, Elite Bid Market (EBM) was born out of a love for
        auctions and a desire to create a fair and transparent platform for our
        ...
        <div className='mb-5'>
          ...
          to get our customers the satisfaction they want at a bargain at times
          and leaving the door steps with nothing less than happy satisfaction.
          Thank you!<br></br>
          <br></br>
        </div>
      </div>
