  ...
  return (
    <>
      <div className='bg-primary flex justify-around p-10 text-subtext'>
        ...
        <div
          className='my-30 flex w-full h-full text-center flex-col text-subtitle'
        ...
        <div
          className='my-30 flex w-full h-full text-left flex-col text-subtitle'
          style={{ display: "flex", alignItems: "flex-start" }}
        >
          <p
            style={{
          ...
          >
            <span style={{ fontWeight: "normal" }}>Jose Martinez</span> is
