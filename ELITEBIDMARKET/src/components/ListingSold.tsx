...
const ListingSold = (props: ItemProps) => {
  return (
    <div className='flex flex-col bg-white rounded-lg hover:border-yellow-500 hover:border-[0.5px] border-[0.5px] shadow-custom cursor-pointer'>
      ...
      {/* Car Image */}
      <div className='flex '>
        <img src={props.image} alt="car image" className=' rounded-t-lg object-cover' />
      </div>
      ...
      <div className='flex flex-col m-2'>
        ...
        <div className='flex text-gray font-bold text-auctioneername pb-1 '>
          ...
          <img src={verified_icon} alt="Verfied Icon" className='ml-3 max-w-[20px] h-auto w-auto object-contain'/>
        </div>
        ...
        <div className='flex lg:mb-5 md:mb-4 mb-3'>
          ...
          <div className='flex flex-col flex-1'>
            <div className='text-gray text-auctionsubtitle font-semibold pb-1'>Sold</div>
            <div className='text-black font-bold text-auctioninfo'>{props.currentBid}</div>
          </div>

          {/* End Time */}
          <div className='flex flex-col flex-1'>
            <div className='text-gray text-auctionsubtitle font-semibold pb-1'>Ended On</div>
            <div className='text-black font-bold text-auctioninfo'>{props.endTime}</div>
          </div>
        </div>
